...
const Login = () => {
  ...
  return (
    <div className=" text-white py-14 container">
      <h1 className=" font-bold text-2xl  text-center">
        Login to Get Started
      </h1>

      <div className="flex flex-col  items-center gap-2 min-h-screen  p-10">
        <button className="flex items-center w-64 text-center bg-slate-100  border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-black hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <svg
        ...
        <button onClick={() => {signIn("github")}} className="flex items-center w-64 text-center bg-slate-100  border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-black hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" >
          <svg
            className="h-6 w-6 mr-2"
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
